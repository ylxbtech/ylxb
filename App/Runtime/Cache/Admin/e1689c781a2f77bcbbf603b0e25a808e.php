                ...
                <div class="result-content">
                    <table class="result-tab" width="100%">
                        ...
                        <?php if(is_array($rows)): $i = 0; $__LIST__ = $rows;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$rows): $mod = ($i % 2 );++$i;?><tr>
                                    ...
                                    <td title=""><a target="_blank" href="#" title=""><?php echo ($rows["catename"]); ?></a></td>
                                    <td>
                                        <a class="link-update" href="/testylxb/index.php/Admin/Cate/edit/id/<?php echo ($rows["id"]); ?>">修改</a>
                                        <a class="link-del" onclick="return confirm('确认删除？')" href="/testylxb/index.php/Admin/Cate/del/id/<?php echo ($rows["id"]); ?>">删除</a>
                                    </td>
