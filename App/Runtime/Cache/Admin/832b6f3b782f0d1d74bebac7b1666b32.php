...
<div class="container clearfix">
    ...
    <div class="main-wrap">
        ...
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="<?php echo U('Index/index');?>">首页</a><span class="crumb-step">&gt;</span><span class="crumb-name">Banner管理</span></div>
        </div>

        <div class="result-wrap">
            <form name="myform" id="myform" method="post" action="<?php echo U('Banner/sort');?>">
                <div class="result-title">
                    <div class="result-list">
                        <a href="<?php echo U('Banner/add');?>"><i class="icon-font"></i>新增Banner</a>
                ...
                <div class="result-content">
                    <table class="result-tab" width="100%">
                        ...
                        <?php if(is_array($picList)): $i = 0; $__LIST__ = $picList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$rows): $mod = ($i % 2 );++$i;?><tr>
                                    <td>
                                        <input class="common-input sort-input" name="<?php echo ($rows["id"]); ?>" value= "<?php echo ($rows["sort"]); ?>" type="text">
                                    </td>
                                    <td><?php echo ($rows["id"]); ?></td>
                                    <td title=""><a target="_blank" href="<?php echo ($rows["url"]); ?>" title="标题"><?php echo ($rows["url"]); ?></a></td>
                                    <td title=""><a target="_blank" href="/testylxb/<?php echo ($rows["pic"]); ?>" title="点击查看原图">/<?php echo ($rows["pic"]); ?></a></td>
                                    <td title=""><a target="_blank" title="预览图片">
                                        <img src="/testylxb/<?php echo ($rows["pic"]); ?>" height="100px">
                                    </a></td>
                                    <td>
                                        <a class="link-update" href="/testylxb/index.php/Admin/Banner/edit/id/<?php echo ($rows["id"]); ?>">修改</a>
                                        <a class="link-del" onclick="return confirm('确认删除？')" href="/testylxb/index.php/Admin/Banner/del/id/<?php echo ($rows["id"]); ?>">删除</a>
                                    </td>
