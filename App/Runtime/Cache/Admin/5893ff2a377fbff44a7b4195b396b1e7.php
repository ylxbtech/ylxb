...
<div class="container clearfix">
    ...
    <div class="main-wrap">
        ...
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="<?php echo U('Index/index');?>">首页</a><span class="crumb-step">&gt;</span><a class="crumb-name" href="<?php echo U('Banner/lis');?>">Banner管理</a><span class="crumb-step">&gt;</span><span>新增Banner</span></div>
        </div>
        <div class="result-wrap">
            <div class="result-content">
                <form action="<?php echo U('Banner/add');?>" method="post" id="myform" name="myform" enctype="multipart/form-data">
                    <table class="insert-tab" width="100%">
                        <tbody>
                            <tr>
                                <th><i class="require-red">*</i>URL：</th>
                                <td>
                                    <input class="common-text required" id="url" name="url" size="50" type="text" placeholder="请输入Banner所指向的Banner">
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a class="btn btn6" href="<?php echo U('Banner/lis');?>">返回</a>
