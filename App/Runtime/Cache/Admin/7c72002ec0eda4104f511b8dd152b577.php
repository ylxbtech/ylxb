...
<div class="container clearfix">
    ...
    <div class="main-wrap">
        ...
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="<?php echo U('Index/index');?>">首页</a><span class="crumb-step">&gt;</span><a class="crumb-name" href="<?php echo U('Link/lis');?>">链接管理</a><span class="crumb-step">&gt;</span><span>新增链接</span></div>
        </div>
        <div class="result-wrap">
            <div class="result-content">
                <form action="<?php echo U('Link/add');?>" method="post" id="myform" name="myform" enctype="multipart/form-data">
                    <table class="insert-tab" width="100%">
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <!--<input class="common-text required" id="desc" name="desc" size="50" value="" type="text">-->
                                    <textarea class="common-text required" id="desc" name="desc" style="font-size: 16px;padding: 2px 4px;width: 420px;height: 100px;margin-top: 15px"></textarea>
                                </td>
                            </tr>
                            <tr>
                                <th></th>
