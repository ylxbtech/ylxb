...
<div class="container clearfix">
    ...
    <div class="main-wrap">
        ...
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="<?php echo U('Index/index');?>">首页</a><span class="crumb-step">&gt;</span><a class="crumb-name" href="<?php echo U('Article/lis');?>">文章管理</a><span class="crumb-step">&gt;</span><span>写文章</span></div>
        </div>
                    ...
                    <table class="insert-tab" width="100%">
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <textarea class="common-text required" id="desc" name="desc" style="font-size: 16px;padding: 4px 4px;width: 420px;height: 50px;margin-top: 15px"></textarea>
                                </td>
                            </tr>

                            <tr style="line-height: 0px ">
                                <th><i class="require-red">*</i>内容：</th>
                                <td><textarea name="content" id="editor" type="text/plain" style="width:1024px;height:500px;"></textarea></td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    <select name="cateid">
                                        ...
                                        <?php if(is_array($cateres)): $i = 0; $__LIST__ = $cateres;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$cate): $mod = ($i % 2 );++$i;?><option value="<?php echo ($cate["id"]); ?>"><?php echo ($cate["catename"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
